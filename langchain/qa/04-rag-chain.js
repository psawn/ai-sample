...
async function main() {
  ...
  // Document Chain: ghép Document + câu hỏi vào prompt, rồi gọi API Gemini (LLM) để sinh câu trả lời.
  ...
  // Retrieval Chain nối Retriever (gọi API Gemini lấy document liên quan) với
  // Document Chain (gọi API Gemini sinh câu trả lời) thành một pipeline duy nhất.
